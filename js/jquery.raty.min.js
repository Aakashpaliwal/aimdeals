...
var o=e.extend( {
}, e.fn.raty.defaults, r), v=e(this), m=this.attr("id"), n=0, w=o.starOn, s="", u=o.target, l=(o.width)?o.width:(o.number*o.size+o.number*4);
if(m===undefined) {
m="raty-"+v.index();
v.attr("id", m);
}
...
v.append('<images id="'+m+"-"+t+'" src="'+o.path+w+'" alt="'+t+'" title="'+s+'" class="'+m+'"/>').append((t<o.number)?"&nbsp;":"");
}
if(o.iconRange&&n>0) {
b(m, n, o);
}
var q=e("<input/>", {
id:m+"-score", type:"hidden", name:o.scoreName
}
).appendTo(v);
if(n>0) {
q.val(n);
...
if(o.cancel) {
var p=e("images."+m), x='<images src="'+o.path+o.cancelOff+'" alt="x" title="'+o.cancelHint+'" class="button-cancel"/>';
...
e("#"+m+" images.button-cancel").mouseenter(function() {
...
function h(n, m, o) {
var q=n.attr("id"), p=e("input#"+q+"-score"), l=n.children("images."+q);
...
function b(l, n, m) {
var o=e("images."+l).length, t=0, r=0, s, p;
for(var q=1;
q<=o;
q++) {
s=e("images#"+l+"-"+q);
...
m.attr("title", n).children("images").attr("title", n);
}
function i(l) {
...
var o=m.attr("id");
if(isNaN(parseInt(n))) {
m.children("images."+o).attr("src", l.path+l.starOff);
...
if(o>0.25&&o<=0.75) {
l=l-0.5;
e("images#"+q+"-"+Math.ceil(l)).attr("src", m.path+m.starHalf);
}
else {
if(o>0.75) {
l--;
...
e("images#"+q+"-"+l).attr("src", m.path+m.starOn);
}
}
}
...
var n=j(o, m, "readOnly"), l=e(m).data("options"), p=n.children("images.button-cancel");
if(m.indexOf(".")>=0) {
return;
}
if(p[0]) {
...
e.fn.raty.defaults= {
cancel:false, cancelHint:"cancel this rating!", cancelOff:"cancel-off.png", cancelOn:"cancel-on.png", cancelPlace:"left", click:null, half:false, hintList:["bad", "poor", "regular", "good", "gorgeous"], noRatedMsg:"not rated yet", number:5, path:"images/", iconRange:[], readOnly:false, scoreName:"score", size:16, starHalf:"star-half.png", starOff:"star-off.png", starOn:"star-on.png", start:0, target:null, targetKeep:false, targetType:"hint", width:null
};
}
)(jQuery);
